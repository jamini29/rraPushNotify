...
class DbConnect
{
	...
	function connect()
	{
		...
		if (mysqli_connect_errno()) {
			$this->raise_error(printf("Connect failed: %s\n", mysqli_connect_error()));
                ...
                // work with UTC connection to simplify datatime interconnection
	...
	*/
	function raise_error($error_message = '')
	{
		...
		else die("There seems to have been a slight problem with our database, please try again later.\n$message");
	}
}
